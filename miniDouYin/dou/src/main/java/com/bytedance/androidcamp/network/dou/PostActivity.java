...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ibPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                postVideo();
                Intent intent = new Intent(PostActivity.this, FrontActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        ibDraft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(args.hasDraft == true){
                    ...
                    Intent intent = new Intent(PostActivity.this, FrontActivity.class);
                    startActivity(intent);
                    return;
                }
                Intent intent = new Intent(PostActivity.this, FrontActivity.class);
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> call = miniDouyinService.postVideo("18888912236","kjs",coverImagePart,videoPart);
